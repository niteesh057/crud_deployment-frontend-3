...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://crud-deployment-backend-3.onrender.com/StudentRoute/update-student/"+id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-deployment-backend-3.onrender.com/StudentRoute/update-student/"+id, data)
        .then((res)=>{
            if(res.status === 200)
